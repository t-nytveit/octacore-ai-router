...
# 9. INTEGRERT SIDEBAR (Nå fullstendig låst med st.image for stabil visning)
with st.sidebar:
    # Erstatter teksttittelen fullstendig med logoen din via native Streamlit-rendring
...
# 10. Hovedskjerm - Ren og minimalistisk uten løse undertitler på avveie
...
if user_prompt := st.chat_input(f"Snakk med {octa_name}..."):
    ...
    if er_teknisk := ("kode" in user_prompt.lower() or "arkitektur" in user_prompt.lower() or octa_persona == "Teknisk arkitekt / Seniorutvikler"):
        rekkefølge = [
